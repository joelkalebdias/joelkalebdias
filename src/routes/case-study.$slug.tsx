      ...
      <div className="w-full max-w-[1280px] flex flex-col gap-6 relative z-10">
        ...
        <PanelShell>
          <PanelHeader
            ...
            gradient="linear-gradient(180deg, #FBFFF6 0%, #94D5FF 50%, #64C8FF 100%)"
          />
          <div className="px-4 pt-4 flex flex-col gap-4">
            <p
              style={{
    ...
    >
      ...
      <div className="w-full max-w-[1280px] flex flex-col gap-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <PanelShell>
            <PanelHeader label="Target Audience" gradient="linear-gradient(180deg, #FBFFF6 0%, #94D5FF 50%, #64C8FF 100%)" />
            <div className="px-4 pt-4">
              <p style={{ ...pixelBody, color: "#320032", fontSize: 16, lineHeight: 1.4, margin: 0, letterSpacing: "-0.01em" }}>
                {G.targetAudience}
              </p>
        ...
        <PanelShell style={{ paddingBottom: 0 }}>
          <PanelHeader label="Competition & Benchmarking" gradient="linear-gradient(180deg, #FBFFF6 0%, #94D5FF 50%, #64C8FF 100%)" />
              ...
              <div className="grid" style={{ gridTemplateColumns: `minmax(160px,0.9fr) repeat(${G.competition.apps.length}, minmax(0,1fr))` }}>
                ...
                >
                  ...
                  <svg
                    ...
                    viewBox="0 0 100 100"
                  >
                    <line x1="0" y1="0" x2="100" y2="100" stroke="#64C8FF" strokeWidth="0.5" vectorEffect="non-scaling-stroke" />
                  </svg>
                  <span
                    style={{
                      ...pixelBody,
        ...
        {/* Branding */}
        <PanelShell>
          <PanelHeader label="Branding" gradient="linear-gradient(180deg, #FBFFF6 0%, #94D5FF 50%, #64C8FF 100%)" />
